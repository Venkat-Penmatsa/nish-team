...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'finance/revenueReport', component: RevenueReportComponent },
      ...
      {
        path: 'hr/generateMontlyTimeSheetReports',
        component: AllEmpMonthlyLeaveReportComponent,
      },
      {
        path: 'hr/generateContractBasedTimeSheetReport',
        component: ContractBasedTimesheetComponent,
      },
